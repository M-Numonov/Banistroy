...
{   public static function show404(){
    ...
    public static function iResize($id, $width, $height, $type=0, $ifno=false)
    {
        ...
        $img = "";
        if($type==0){
            $img=CFile::ResizeImageGet($id, array('width'=>$width, "height"=>$height), BX_RESIZE_IMAGE_EXACT, true);
        }elseif($type==1){
            $img=CFile::ResizeImageGet($id, array('width'=>$width, "height"=>$height), BX_RESIZE_IMAGE_PROPORTIONAL, true);
        }else{
            $img=CFile::ResizeImageGet($id, array('width'=>$width, "height"=>$height), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true);
        }
        return $img["src"];
    }
    public static function GetNoPhoto($width, $height, $ifno = false)
    {
        if ($ifno == false){
            ...
            $n_file=$_SERVER["DOCUMENT_ROOT"]."/upload/no_photo/".$width."_".$height."/no_photo_clinic.png";
            $main = $_SERVER["DOCUMENT_ROOT"]."/upload/no_photo_clinic.png";
        }elseif($ifno=="doctor"){
            $n_file=$_SERVER["DOCUMENT_ROOT"]."/upload/no_photo/".$width."_".$height."/no_photo_doctor.png";
            $main = $_SERVER["DOCUMENT_ROOT"]."/upload/no_photo_doctor.png";
        }
