...
$is_filter = CIBlockElement::GetList([], ["IBLOCK_ID" => PROJECTS_IBLOCK_ID, "SECTION_ID" => $arCurSection["ID"]], false, ["nTopCount" => 1], ["ID"])->GetNext();
$section_list = $APPLICATION->IncludeComponent(
...
//if (section list){
/*<?$this->SetViewTarget('SECTION_CLASS');*/ ?><!--dec-right-green--><? /*$this->EndViewTarget();*/ ?>
<!--}-->
