...
?>
<div class="row indent-bt">

    <div class="col-md-12">
        <div class="col-md-6">
            <div class="global-photo">
                <img src="<?= ZakHelper::iResize($arResult["DETAIL_PICTURE"]["ID"], 550, 320, 1) ?>" alt="photo"/>
            </div>
        </div>
<?
$actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
$img_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]";
if ($arResult["DETAIL_PICTURE"]){
    $img_link = $img_link.$arResult["DETAIL_PICTURE"]["SRC"];
}else{
    $img_link = $img_link.$arResult["PREVIEW_PICTURE"]["SRC"];
}
...
?>
        ...
        <ul class="social">
            <li>
                <a target="_blank" href="https://connect.ok.ru/offer?url=<?=urlencode($actual_link)?>&title=<?=urlencode($arResult["NAME"])?>&imageUrl=<?=urlencode($img_link)?>">
                    <xml version="1.0">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Bold" enable-background="new 0 0 24 24"
                             viewBox="0 0 24 24" class="social-i">
                            <g>
                                <path d="m4.721 12.881c-.613 1.205.083 1.781 1.671 2.765 1.35.834 3.215 1.139 4.413 1.261-.491.472 1.759-1.692-4.721 4.541-1.374 1.317.838 3.43 2.211 2.141l3.717-3.585c1.423 1.369 2.787 2.681 3.717 3.59 1.374 1.294 3.585-.801 2.226-2.141-.102-.097-5.037-4.831-4.736-4.541 1.213-.122 3.05-.445 4.384-1.261l-.001-.001c1.588-.989 2.284-1.564 1.68-2.769-.365-.684-1.349-1.256-2.659-.267 0 0-1.769 1.355-4.622 1.355-2.854 0-4.622-1.355-4.622-1.355-1.309-.994-2.297-.417-2.658.267z"
                                      data-original="#000000" class="social-i" data-old_color="#000000"/>
            ...
            <li>
                <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?=$actual_link?>">
                    <xml version="1.0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                             id="Capa_1" x="0px" y="0px" viewBox="0 0 470.513 470.513"
                             style="enable-background:new 0 0 470.513 470.513;" xml:space="preserve"><g>
                                <g>
                                    <path d="M271.521,154.17v-40.541c0-6.086,0.28-10.8,0.849-14.13c0.567-3.335,1.857-6.615,3.859-9.853   c1.999-3.236,5.236-5.47,9.706-6.708c4.476-1.24,10.424-1.858,17.85-1.858h40.539V0h-64.809c-37.5,0-64.433,8.897-80.803,26.691   c-16.368,17.798-24.551,44.014-24.551,78.658v48.82h-48.542v81.086h48.539v235.256h97.362V235.256h64.805l8.566-81.086H271.521z"
                                          ...
                                          class="social-i" data-old_color="#000000"/>
                                </g>
                            </g></svg>
                    </xml>
                </a>
            ...
            <li>
                <a target="_blank" href="https://vk.com/share.php?url=<?=$actual_link?>">
                    <xml version="1.0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                             id="Capa_1" x="0px" y="0px" viewBox="0 0 31.334 31.334"
                             style="enable-background:new 0 0 31.334 31.334;" xml:space="preserve"><g>
                                <g>
